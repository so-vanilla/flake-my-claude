...
COMPILER_DIGEST = "sha256:a27f5ebe7f8cfb4a8981a233f00e0297b7a0c80efc64642b67947c9d8af2e8db"
...
class DecisionOutcomePhysicalBindingTests(unittest.TestCase):
    ...
    def test_frozen_wave_one_and_fixed_git_head_are_unchanged(self):
        ...
        self.assertEqual(FIXED_HEAD, actual)
