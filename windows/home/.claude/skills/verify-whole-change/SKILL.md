...
contribution, non-goals, execution closure, fresh actor/Epoch assignment, and
remaining finite budget. The verifier must be independent of implementation;
...
that exposes all unverified risk and typed stops. Budget exhaustion is
`stopped_budget`, never a pass. This task-scoped verification is not Workflow
