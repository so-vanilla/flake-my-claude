...
execution closure, actor assignment, Epoch, freshness, and finite review budget.
...
attempt whose inputs and provenance are reproducible. Stop at the package
time/round limit or on stale or incomplete inputs. The Reviewer neither edits
